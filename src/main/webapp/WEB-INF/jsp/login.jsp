	...
	<div id="login_container">
		<form name="login_form" action="" method="post">
			...
			<div id="account_container">
				...
				<input type="text" name="account" placeholder="血压管家邮箱或手机号"
					required="required" />
			</div>
		...
		<div id="login_other">
			<a href="/index.php/home/register/forget.html"><p id="forget_pwd">忘记密码
					&gt;</p></a> <a href="/index.php/home/register/register.html"><button
					id="register">免费注册</button></a>
		</div>
		<script type="text/javascript">
