...
public final class FrameWorkConstants {
    ...
    /**
     * CONFIG_PROPERTIES:config配置文件<br>
     */
    public static final String CONFIG_PROPERTIES = "config";

    /**
     * ERORR_CODE_PROPERTIES_BASENAME:error_code配置基名 <br>
     */
    ...
    /** Date null时间 */
    public static final Date NULL_DATE = DateHelper.string2Date("1900-01-01",
            DateHelper.STR_DATE_FORMAT_DAY_WITH_SPLIT);
    ...
    /** 日期类型的失效时间 */
    public static final Date EXP_DATE_DATE_TYPE = DateHelper.string2Date(
            EXP_DATE, EXP_DATE_FORMAT);

    /** 日期类型的失效时间 */
    public static final Date MAX_EXP_DATE_TYPE = DateHelper.string2Date(
