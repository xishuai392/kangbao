...
public final class Constants {
    ...
    /** Date null时间 */
    public static final Date NULL_DATE = DateHelper.string2Date("1900-01-01", DateHelper.DATE_FORMAT_DAY);
    ...
    /** 日期类型的失效时间 */
    public static final Date EXP_DATE_DATE_TYPE = DateHelper.string2Date(EXP_DATE, EXP_DATE_FORMAT);

    /** 日期类型的失效时间 */
    public static final Date MAX_EXP_DATE_TYPE = DateHelper.string2Date(MAX_EXP_DATE, EXP_DATE_FORMAT);
    ...
    /** 有效状态 */
    public static final String STATUS_AP_EFF = "30A";

    /** 等待激活状态 */
    public static final String STATUS_AP_WAIT_ACTIVE = "30C";
